 ...
 * This process starts from the root node and then traverses all through that branch until it reaches the leaf,
 * the last node with no other children, and then backtracks. This continues until all nodes have been traversed.
 */
