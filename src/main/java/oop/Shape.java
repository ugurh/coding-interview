...
class Rectangle1 extends Shape {   // extended form the Shape class

    private double width;
    private double height;

    public Rectangle1(double width, double heigh) {
        this.width = width;
        this.height = heigh;
    }
...
class ShapeDriver {
    ...
    public static void main(String args[]) {
        ...
        shape[1] = new Rectangle1(2, 2); // creating rectangle object at index 1
